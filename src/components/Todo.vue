<template>
  <section class="todoapp">
    ...
    <footer class="footer" v-show="todos.length > 0">
      ...
      <ul class="filters">
        <li><a href="#" :class="{selected: filter === 'all'}" @click.prevent="filter = 'all'"></a>Toutes</li>
        <li><a href="#" :class="{selected: filter === 'todo'}" @click.prevent="filter = 'todo'"></a>A faire</li>
        <li><a href="#" :class="{selected: filter === 'done'}" @click.prevent="filter = 'done'"></a>Faites</li>
      </ul>
